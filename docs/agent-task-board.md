...
| LC-V1 | cert/litellm-chat-v1 | Copilot | partial | 2026-03-25T03:45:00Z | 2026-03-25T03:45:00Z | 11 of 14 criteria pass. Implemented: 30 CODERO_CHAT_* config vars, chat history endpoints (GET/DELETE /api/v1/chat/history), ConversationStore, 6 quick query expansions (/prs, /agent, /session, /recent, /blocked, /health), conversation logging in postChat. 20 clause-mapped tests. Missing: multi-turn context not sent to LiteLLM, tool use deferred per spec, conversation_id/context_scope missing from ChatRequest. |
