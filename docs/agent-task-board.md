...
| RC-V1 | feat/RC-V1-closeout | Copilot | done | 2026-03-24T14:56:00Z | 2026-03-24T15:15:00Z | Repo-Context v1 closeout: SQLite graph store at `.codero/context/graph.db`, Go AST indexer (full+incremental), 8 `codero context` commands (index/status/find/grep/symbols/deps/rdeps/impact), advisory-only impact analysis with risk heuristic, 24 tests, advisory-only boundary enforced. |
| GATE-V1 | feat/GATE-V1-closeout | Copilot | done | 2026-03-24T14:30:00Z | 2026-03-24T14:45:00Z | Gate Config v1 closeout: machine-global `$HOME/.codero/config.env` source of truth, 20-key spec env matrix with tier system (always-on/configurable/opt-in/AI), spec precedence (shell env > config file > defaults), dashboard GET/PUT endpoints, atomic saves, drift detection, backward-compatible legacy env vars, 28 new tests. |
