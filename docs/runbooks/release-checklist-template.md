...
| 1.6 | E2E gate (race): `go test -tags=e2e -race -count=1 ./tests/e2e/ -v` | All 4 tests PASS, 0 races | ☐ PASS / ☐ FAIL | |
...
| 1.11 | Changelog / PR description written | Linked issue, scope summary, tests run, deploy impact, env var changes | ☐ DONE | |
