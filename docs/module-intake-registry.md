...
| MI-005 | mathkit-v2 two-pass local review gate | workflow/review-gate | phase1-prep | docs/contracts/review-gate-v1.md | pending | docs/review-workflow.md | LiteLLM first pass + CodeRabbit second pass |
