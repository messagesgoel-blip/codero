...
| MI-005 | mathkit-v2 two-pass local review gate | workflow/review-gate | integrated-v1 | docs/contracts/review-gate-v1.md | scripts/review/two-pass-review.sh | docs/review-workflow.md | LiteLLM first pass + CodeRabbit second pass; parity validated via live pre-commit gate |
